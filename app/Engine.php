...
class Engine {
    ...
    public function init() {
        ...
        $this->set('web.views.path', __DIR__.'/views');
        $this->set('web.views.cache', __DIR__.'/views/cache');
        ...
        $this->path($this->get('web.libs.path'));
